...
class HLLM(BaseModel):
    ...
    def forward_item_emb(
        ...
        emb_tokens,
        llm
    ):#input_ids.shape = (14606)
        inputs_embeds = llm.get_input_embeddings()(input_ids) # (14606,2048)
    ...
    def forward(self, interaction, mode='train'):
        if mode == 'predict':#interaction[0].shape = (256,10) # interaction[1].shape = (256,10,6),interaction[2].shape = (82865,2048)
